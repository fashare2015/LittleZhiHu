...
public interface StickyRecyclerHeadersAdapter<VH extends RecyclerView.ViewHolder> extends SectionIndexer{
     ...
     */
    // this method is deprecated. use SectionIndexer.getPositionForSection() instead
